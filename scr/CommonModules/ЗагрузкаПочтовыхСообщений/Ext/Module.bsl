...
Функция ПрочитатьПисьма(Параметры) Экспорт
	...
	//ОКЕЙ Цветков А. (СофтЛаб) Начало 2019-11-22 (#3546)
	// Проблема при обработке входящих сообщений в служебных почтовых ящиках
	ПараметрыОтбораЗаголовков.Вставить("Удаленные", Ложь);
	//ОКЕЙ Цветков А. (СофтЛаб) Конец 2019-11-22 (#3546)	

...
Функция СтрокаИзДвоичныхДанных(Знач Данные) Экспорт
	...
	//есть места, где банк-клиент передает вместо двоичных данных адрес с ними в хранилище
	//Если ТипЗнч(ДвоичныеДанные) = Тип("ДвоичныеДанные") Тогда
	ТипЗначения = ТипЗнч(ДвоичныеДанные);
	...
	//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-05-26 (#3317)
	ИначеЕсли ТипЗначения = Тип("Строка") И ЭтоАдресВременногоХранилища(ДвоичныеДанные) Тогда
		Возврат СтрокаИзДвоичныхДанных(ПолучитьИзВременногоХранилища(ДвоичныеДанные));
	//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-05-26 (#3317)		
	КонецЕсли;

...
Функция Счет(УсловныйКодСчета) Экспорт
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-02-15 (#4033) 	
		//Результат = ПС.РасчетыПоАвансамПолученнымУЕВСчетОтгрузки;
	...
	ИначеЕсли УсловныйКодСчета = "008" Тогда
		//Результат = ПС.ОбеспеченияОбязательствИПлатежейПолученные;   //Довбешка
		Результат = ПС.ОбеспеченияОбязательствПолученные;
	ИначеЕсли УсловныйКодСчета = "009" Тогда
		//Результат = ПС.ОбеспеченияОбязательствИПлатежейВыданные;    //Довбешка

...
Функция РеквизитыРасшифровкаПлатежа()
	...
	// бит_Финанс изменения кода. Начало.
	РеквизитыРасшифровкиПлатежа.Вставить("бит_КлючСтроки","");
	// бит_Финанс изменения кода. Конец. 
...
Функция ДанныеРасшифровкиПлатежаОднострочнойФормы(Форма) Экспорт
	...
	// бит_Финанс изменения кода. Начало.
	Результат.бит_КлючСтроки = Форма.РасшифровкаПлатежабит_КлючСтроки;
	// бит_Финанс изменения кода. Конец. 
...
Функция СвойстваСтрокРасшифровкиПлатежа(ПараметрыОбъекта, ПолучатьДоговор) Экспорт
	...
	Иначе
		...
		ПараметрыПлатежа = Новый Структура("ВидОперации, Организация, Дата, Контрагент, ДоговорКонтрагента,
			|ПрименениеУСН, ПрименяетсяОсобыйПорядокНалогообложения, ПлательщикНДС, ПлательщикНПД,

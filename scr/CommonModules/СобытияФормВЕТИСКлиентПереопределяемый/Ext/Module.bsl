...
Процедура ОткрытьФормуСозданияНоменклатуры(Форма, ПараметрыНоменклатуры, ЕдиницаИзмеренияВЕТИС) Экспорт
	...
	Если ЗначениеЗаполнено(ПараметрыНоменклатуры) Тогда
		...
		ЗначенияЗаполнения.Вставить("Наименование",       ПараметрыНоменклатуры.НаименованиеНоменклатурыВЕТИС);
		ЗначенияЗаполнения.Вставить("НаименованиеПолное", ПараметрыНоменклатуры.НаименованиеНоменклатурыВЕТИС);

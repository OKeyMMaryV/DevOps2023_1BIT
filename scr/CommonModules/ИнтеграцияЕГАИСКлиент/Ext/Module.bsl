...
Функция ЗаголовокФормыЗагрузкиКодовМаркировки(Форма, ДоступнаИерархия = Ложь) Экспорт
	
	Если ДоступнаИерархия Тогда
		
		Возврат НСтр("ru = 'Загрузка акцизных марок и упаковок алкогольной продукции'");
		
	Иначе
		
		Возврат СтрШаблон(НСтр("ru = 'Загрузка акцизных марок в %1'"), Форма.Объект);

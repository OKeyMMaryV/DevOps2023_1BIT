...
Процедура ЗаполнитьСведенияОПерсональныхДанных(ТаблицаСведений) Экспорт
	...
	//ОКЕЙ Завьялова Е.А. (ПервыйБИТ) Начало 2021-05-04 (#ТП_БП05_ФР11)
	// Для автоматической регистрации доступа к персональным данным.
	НовыеСведения = ТаблицаСведений.Добавить();
	НовыеСведения.Объект			= "РегистрСведений.ок_ДанныеФизическихЛицБОСС";
	НовыеСведения.ПоляРегистрации	= "ФизическоеЛицо,КодБОСС";
	НовыеСведения.ПоляДоступа		= "Фамилия,Имя,Отчество,ДатаРождения,Гражданство,СерияДокумента,НомерДокумента,ДатаВыдачиДокумента,КемВыданДокумент,Должность,Функция,Объект,ДатаПриема,ДатаУвольнения,КодПриемаНаРаботу,БИКБанка,НомерРасчетногоСчета";
	НовыеСведения.ОбластьДанных		= "ЛичныеДанные";
	//ОКЕЙ Завьялова Е.А. (ПервыйБИТ) Конец 2021-05-04 (#ТП_БП05_ФР11)
...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.ЗаявлениеОПредоставленииСведенийОТрудовойДеятельности);

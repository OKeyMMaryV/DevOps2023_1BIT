...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Версия = бит_ОбщегоНазначения.МетаданныеВерсия();
...
#КонецОбласти
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.62.4";
	Обработчик.Процедура           = "ИнтеграцияЕГАИСБП.ОбработатьОснованияЕГАИС";
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Идентификатор       = Новый УникальныйИдентификатор("49441f6f-cc8e-4cae-bef8-d093de2c2416");
	Обработчик.НачальноеЗаполнение = Ложь;
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.68.19";
	Обработчик.Процедура           = "УчетЗарплаты.ЗаполнитьПроизводственныйКалендарьПоУмолчанию";
	Обработчик.НачальноеЗаполнение = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.68.21";
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              = "3.0.71.16";
	Обработчик.Процедура           = "Справочники.КлассификаторВидовПредпринимательскойДеятельностиПСН.Обновить";
	Обработчик.НачальноеЗаполнение = Истина;
	Обработчик.ОбщиеДанные         = Истина;
	...
	Обработчик.РежимВыполнения     = "Отложенно";
	Обработчик.Идентификатор       = Новый УникальныйИдентификатор("7f64c1a3-03ab-4cca-8682-7b4191d2c86a");
...
Процедура УстановитьДатуТекущейВерсии() Экспорт
	...
	Константы.ДатаТекущейВерсии.Установить(Дата(2020,02,12));

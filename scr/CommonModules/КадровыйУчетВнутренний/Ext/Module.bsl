...
Функция ЗапросВТОтборСотрудниковОрганизации(ТолькоРазрешенные, Параметры, ИмяВТСотрудникиПериоды) Экспорт
	...
	Возврат КадровыйУчетБазовый.ЗапросВТОтборСотрудниковОрганизации(ТолькоРазрешенные, Параметры, ИмяВТСотрудникиПериоды);
...
Функция ЗапросВТСотрудникиОрганизацииПоРабочимМестам(ТолькоРазрешенные, ИмяВТСотрудникиОрганизации, ИмяВТСотрудникиПериоды, Параметры, МенеджерВременныхТаблиц) Экспорт
	...
	Возврат КадровыйУчетБазовый.ЗапросВТСотрудникиОрганизацииПоРабочимМестам(ТолькоРазрешенные, ИмяВТСотрудникиОрганизации, ИмяВТСотрудникиПериоды, Параметры, МенеджерВременныхТаблиц);
...
Функция ПредставлениеСтатьиУвольненияДляТ8(СтатьяУвольнения) Экспорт
	...
	Возврат КадровыйУчетБазовый.ПредставлениеСтатьиУвольненияДляТ8(СтатьяУвольнения);
	
КонецФункции

Функция НормативныйДокументОснованияУвольнения(ОснованиеУвольнения) Экспорт
	
	Возврат КадровыйУчетБазовый.НормативныйДокументОснованияУвольнения(ОснованиеУвольнения);
...
Функция ПараметрыПолученияВсехСотрудниковОрганизацийПоСпискуФизическихЛиц() Экспорт
	...
	Возврат ПараметрыПолученияСотрудниковОрганизацийПоСпискуФизическихЛиц();
...
Функция ЗапросВТРабочиеМестаСотрудниковПоВременнойТаблице(ТолькоРазрешенные, ИмяВТРабочиеМестаСотрудников, Параметры, МенеджерВременныхТаблиц) Экспорт
	...
	Возврат КадровыйУчетБазовый.ЗапросВТРабочиеМестаСотрудниковПоВременнойТаблице(ТолькоРазрешенные, ИмяВТРабочиеМестаСотрудников, Параметры, МенеджерВременныхТаблиц);
...
Функция РольСотрудникаРаботник() Экспорт 
	Возврат КадровыйУчетБазовый.РольСотрудникаРаботник();
КонецФункции	
...
Процедура ОбработкаПолученияПолейПредставленияСотрудников(Поля, СтандартнаяОбработка) Экспорт
	...
	// В этой конфигурации ничего не выполняется
...
Процедура СоздатьВТОсновныеСотрудникиФизическихЛицВПериодах(МенеджерВременныхТаблиц, ТолькоРазрешенные, ГоловнаяОрганизация, ИмяВТФизическиеЛицаПериоды, ИмяВТОсновныеСотрудникиФизическихЛицВПериодах) Экспорт
	...
	КадровыйУчетБазовый.СоздатьВТОсновныеСотрудникиФизическихЛицВПериодах(МенеджерВременныхТаблиц, ТолькоРазрешенные, ГоловнаяОрганизация, ИмяВТФизическиеЛицаПериоды, ИмяВТОсновныеСотрудникиФизическихЛицВПериодах);
...
Процедура ОбновитьОсновныхСотрудниковФизическихЛицПоСотрудникам(Сотрудники) Экспорт
	...
	КадровыйУчетБазовый.ОбновитьОсновныхСотрудниковФизическихЛицПоСотрудникам(Сотрудники);
	
КонецПроцедуры

Процедура ОбновитьОсновныхСотрудниковФизическихЛицБезТрудовыхДоговоров(Сотрудники) Экспорт
	
	КадровыйУчетБазовый.ОбновитьОсновныхСотрудниковФизическихЛицБезТрудовыхДоговоров(Сотрудники);
...
Процедура СоздатьВТПоследниеРаботавшиеСотрудникиФизическихЛиц(МенеджерВременныхТаблиц, ТолькоРазрешенные, ФизическиеЛица, ПараметрыПолученияСотрудников, ИмяВТПоследниеСотрудники) Экспорт
	...
	КадровыйУчетБазовый.СоздатьВТПоследниеРаботавшиеСотрудникиФизическихЛиц(МенеджерВременныхТаблиц, ТолькоРазрешенные, ФизическиеЛица, ПараметрыПолученияСотрудников, ИмяВТПоследниеСотрудники);
	
КонецПроцедуры

Функция ЗапросВТСобытияТрудовыхКнижек(Организация, ТолькоРазрешенные) Экспорт
	
	Возврат КадровыйУчетБазовый.ЗапросВТСобытияТрудовыхКнижек(Организация, ТолькоРазрешенные);

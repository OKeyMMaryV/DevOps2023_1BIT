...
// КОРП, ПРОФ
	...
	// бит_Финанс начало добавления 26.06.2012
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.бит_Полный);
	// бит_Финанс конец добавления 26.06.2012
	// КОРП
	...
	//ОКЕЙ Поздняков А.С. (СофтЛаб) Начало 2020-11-11 (#МДМ)
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.ок_ВыгрузкаВАксапту);
	//ОКЕЙ Поздняков А.С. (СофтЛаб) Конец 2020-11-11 (#МДМ)
...
Процедура РегистрацияИзмененийНачальнойВыгрузкиДанных(Знач Получатель, СтандартнаяОбработка, Отбор) Экспорт
	...
	ОбменДаннымиЗарплатаКадры.РегистрацияИзмененийНачальнойВыгрузкиДанных(Получатель, СтандартнаяОбработка, Отбор);

...
Процедура ВыполнитьСинхронизациюКлассификаторов(ХозяйствующиеСубъекты = Неопределено, ТипыВЕТИС = Неопределено, ПараметрыОбмена = Неопределено) Экспорт
...
Процедура ЗагрузитьНезагруженныеЭлементыКлассификаторов(ХозяйствующиеСубъекты = Неопределено, ТипыВЕТИС = Неопределено, ПараметрыОбмена = Неопределено) Экспорт
...
// * ОписаниеОшибки - String - описание ошибки.
// * КодОшибки - String - код возвращаемой сервисом ошибки.
Функция ПоляОшибки(ОшибкаXDTO) Экспорт

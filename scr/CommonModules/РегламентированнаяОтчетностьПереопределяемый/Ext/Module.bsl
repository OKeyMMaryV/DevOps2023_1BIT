...
Функция ПолучитьСведенияОПоказателяхОтчета(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета = Неопределено) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетНДС" Тогда
		...
		// ОКЕЙ Смирнов М.В. (СофтЛаб) Начало 2021-09-17 (#4354)
		...
		// ОКЕЙ Смирнов М.В. (СофтЛаб) Конец 2021-09-17 (#4354)
		КонецЕсли;
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетПрибыль" Тогда
		...
		Иначе
			...
			ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2019Кв4" Тогда
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетИмущество" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2019Кв1" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2019Кв4"
			//ОКЕЙ Сафронов А.А. (СофтЛаб) Начало 2020-12-23 (#3946)
			...
			//ОКЕЙ Сафронов А.А. (СофтЛаб) Начало 2020-12-23 (#3946)
			//УправлениеВнеоборотнымиАктивами.ПолучитьСведенияОПоказателяхОтчетаИмуществоФормаОтчета2019(ПоказателиОтчета, ИДРедакцииОтчета);
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаОтчета2021Кв3" Тогда
			ПрослеживаемостьФормированиеОтчетности.ПолучитьСведенияОПоказателяхОтчетаОбОперациях(ПоказателиОтчета);
		КонецЕсли;	
...
Процедура ЗаполнитьОтчет(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетИмущество" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2019Кв1" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2019Кв4"
			...
			//ОКЕЙ Сафронов А.А. (СофтЛаб) Начало 2020-12-23 (#3946)
			//УправлениеВнеоборотнымиАктивами.ЗаполнитьОтчетИмуществоФормаОтчета2019(ПараметрыОтчета, Контейнер, ИДРедакцииОтчета);
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетПрослеживаемыеТоварыОтчетОбОперациях" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаОтчета2021Кв3" Тогда
			ПрослеживаемостьФормированиеОтчетности.ЗаполнитьОтчетОбОперациях(ПараметрыОтчета, Контейнер);
		КонецЕсли;
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-07-15 (#4214) 	
	Иначе
...
Процедура ПолучитьНалоговыеОрганы(Организация, ДатаКонцаПериодаОтчета, НалоговыеОрганы, НаименованиеРеглОтчета = "") Экспорт
	...
	Если НаименованиеРеглОтчета = "РегламентированныйОтчет6НДФЛ" Тогда	

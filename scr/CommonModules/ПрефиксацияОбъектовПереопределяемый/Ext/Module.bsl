...
Процедура ПолучитьПрефиксообразующиеРеквизиты(Объекты) Экспорт
	...
	// бит_Финанс добавление кода. Начало. 07.10.2013{{
	СтрокаТаблицы = Объекты.Добавить();
	СтрокаТаблицы.Объект = Метаданные.Документы.бит_вго_ПодтверждениеСверкиВГО;
	СтрокаТаблицы.Реквизит = "Организация1";
    // бит_Финанс добавление кода. Конец. 07.10.2013}}

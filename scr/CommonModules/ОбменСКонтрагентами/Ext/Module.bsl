...
Процедура ИнициализироватьЗапросЭлектронныхДокументовНаПодписи(Запрос, ДляРабочегоСтола = Истина, СтруктураДопОтборов = Неопределено) Экспорт
	...
	|	НастройкиОтправкиЭлектронныхДокументов.ЭтоИнтеркампани КАК ЭтоИнтеркампани
	|ПОМЕСТИТЬ ЭДНаПодпись
	|ИЗ
	|	Справочник.ЭДПрисоединенныеФайлы КАК ЭДПрисоединенныеФайлы
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ втДокументыНаПодписи КАК втДокументыНаПодписи
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.НастройкиОтправкиЭлектронныхДокументов КАК НастройкиОтправкиЭлектронныхДокументов
	...
	|		ПО (ЭДНаПодпись.ЭтоИнтеркампани)
	...
	|		ПО ЭДНаПодпись.ИдентификаторКонтрагента = ПриглашенияКОбменуЭлектроннымиДокументами.ИдентификаторКонтрагента
	|			И ЭДНаПодпись.ИдентификаторОрганизации = ПриглашенияКОбменуЭлектроннымиДокументами.ИдентификаторОрганизации";
...
Процедура ЗаполнитьКешиОператоровЭДОИФорматов(Параметры) Экспорт
	...
	Попытка
		...
		//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-04-02 (#4023) 		
		...
		//ОбновлениеИнформационнойБазы.ЗаписатьНаборЗаписей(НаборЗаписей);
		//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-04-02 (#4023)
...
// См. процедуру ЭлектронноеВзаимодействие.ПриФормированииСпискаУслуг
...
#Область Справочники_УдалитьСоглашенияОбИспользованииЭД_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.ИзменяемыеОбъекты = "РегистрСведений.НастройкиОтправкиЭлектронныхДокументов,"
		+ "РегистрСведений.НастройкиОтправкиЭлектронныхДокументовПоВидам,"
		+ "РегистрСведений.НастройкиПолученияЭлектронныхДокументов,"
		+ "РегистрСведений.ПриглашенияКОбменуЭлектроннымиДокументами,"
		+ "РегистрСведений.СостояниеОрганизацийБЭД,"
...
Функция ТипыДокументов() Экспорт
	...
	ТипыДокументов.Вставить("АктВыполненныхРабот", Перечисления.ВидыЭД.АктВыполненныхРабот);
	ТипыДокументов.Вставить("АктНаПередачуПрав", Перечисления.ВидыЭД.АктНаПередачуПрав);
	ТипыДокументов.Вставить("АктОРасхождениях", Перечисления.ВидыЭД.АктОРасхождениях);
	ТипыДокументов.Вставить("ЗаказТовара", Перечисления.ВидыЭД.ЗаказТовара);
	ТипыДокументов.Вставить("ЗапросКоммерческихПредложений", Перечисления.ВидыЭД.ЗапросКоммерческихПредложений);
	ТипыДокументов.Вставить("КаталогТоваров", Перечисления.ВидыЭД.КаталогТоваров);
	ТипыДокументов.Вставить("КоммерческоеПредложение", Перечисления.ВидыЭД.КоммерческоеПредложение);
	ТипыДокументов.Вставить("КорректировочныйСчетФактура", Перечисления.ВидыЭД.КорректировочныйСчетФактура);
	ТипыДокументов.Вставить("ОтветНаЗаказ", Перечисления.ВидыЭД.ОтветНаЗаказ);
	ТипыДокументов.Вставить("ОтчетОПродажахКомиссионногоТовара", Перечисления.ВидыЭД.ОтчетОПродажахКомиссионногоТовара);
	ТипыДокументов.Вставить("ОтчетОСписанииКомиссионногоТовара", Перечисления.ВидыЭД.ОтчетОСписанииКомиссионногоТовара);
	ТипыДокументов.Вставить("ПрайсЛист", Перечисления.ВидыЭД.ПрайсЛист);
	ТипыДокументов.Вставить("СоглашениеОбИзмененииСтоимостиОтправитель", Перечисления.ВидыЭД.СоглашениеОбИзмененииСтоимостиОтправитель);
	ТипыДокументов.Вставить("СоглашениеОбИзмененииСтоимостиПолучатель", Перечисления.ВидыЭД.СоглашениеОбИзмененииСтоимостиПолучатель);
	ТипыДокументов.Вставить("СчетНаОплату", Перечисления.ВидыЭД.СчетНаОплату);
	ТипыДокументов.Вставить("СчетФактура", Перечисления.ВидыЭД.СчетФактура);
	ТипыДокументов.Вставить("ТоварнаяНакладная", Перечисления.ВидыЭД.ТОРГ12);
	ТипыДокументов.Вставить("КаталогТоваров", Перечисления.ВидыЭД.КаталогТоваров);
	ТипыДокументов.Вставить("УПД", Перечисления.ВидыЭД.УПД);
	ТипыДокументов.Вставить("УКД", Перечисления.ВидыЭД.УКД);

...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	ок_УправлениеФормами.ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка);
	//ОК(СофтЛаб) Вдовиченко Г.В. 20181101 №3103	
...
Процедура ПриЧтенииНаСервере(Форма, ТекущийОбъект) Экспорт
	...
	ок_УправлениеФормами.ПриЧтенииНаСервере(Форма, ТекущийОбъект);
	//ОКЕЙ Наумов А.Н. (СофтЛаб) Начало 2019-09-20 (#3493)	
...
Процедура ДатаПриИзменении(Форма) Экспорт
	...
	Если Объект.Свойство("Товары") Тогда
		РаботаСНоменклатурой.ОбновитьПризнакПрослеживаемости(Объект.Товары, Форма.ВедетсяУчетПрослеживаемыхТоваров);
		Форма.ЗаполнитьДобавленныеКолонкиТаблиц();
	КонецЕсли;
	Если Объект.Свойство("Оборудование") Тогда
		РаботаСНоменклатурой.ОбновитьПризнакПрослеживаемости(Объект.Оборудование, Форма.ВедетсяУчетПрослеживаемыхТоваров);
		Форма.ЗаполнитьДобавленныеКолонкиТаблиц();
	КонецЕсли;
...
Процедура КонтрагентОбработатьИзменение(Форма, ПричиныИзмененияСчетовУчета)
	...
	ОчиститьIDРазноски(Объект, ПричиныИзмененияСчетовУчета);
...
//ОКЕЙ Поздняков А.С. (СофтЛаб) Начало 2020-07-15 (#3758)
Процедура ОчиститьIDРазноски(Объект, ПричиныИзменения = Неопределено)

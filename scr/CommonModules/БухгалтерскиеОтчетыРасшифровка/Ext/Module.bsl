...
Функция НастройкиРасшифровки(АдресРасшифровки, ИдентификаторРасшифровки, ИмяИсходногоОтчета, РеквизитыРасшифровки) Экспорт
	...
	бит_БухгалтерскиеОтчетыКлиентСервер.НовыйУниверсальныеНастройки(Настройки, ИмяИсходногоОтчета);
...
Процедура ОбработатьИзменениеНастройки(Настройки, ИмяНастройки, СтароеЗначение, НовоеЗначение)
	...
	Если ИмяНастройки = "Счет" тогда
		...
		// бит_Финанс изменения кода. Начало.
		бит_БухгалтерскиеОтчетыРасшифровка.ОбработатьИзменениеНастройки(Настройки, ИмяНастройки, СтароеЗначение, НовоеЗначение);
		// бит_Финанс изменения кода. Конец. 

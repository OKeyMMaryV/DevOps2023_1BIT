	...
	Для Каждого СтрокаДанных Из ТаблицаДанных Цикл
		...
		Для Каждого Колонка Из ТаблицаДанных.Колонки Цикл
			Если Колонка.Имя = "ДопДанныеПодписанные" ИЛИ Колонка.Имя = "ДопДанныеНеПодписанные" Тогда
				...
				//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-09-03 (#4281) 
				...
				//
				//Продолжить;	
				//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-09-03 (#4281) 
...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ОбменСКонтрагентами") Тогда
		...
		//пока отключу запрет, а то в тестовой установлен запрет на внешние ресурсы и теперь не протестировать ЭДО СБИС
		НоваяСтрока.РаботаетСВнешнимиРесурсами = Ложь;
...
//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-07-28 (#4214)
...
КонецФункции
//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-07-28 (#4214) 

//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-09-14 (#4281)
Процедура ок_ДобавитьЗаписьВТаблицуДерева(Дерево, Коллекция, НазваниеТаблицы) Экспорт
...
Процедура ок_ДобавитьДопДанныеВДерево(СтрокаДерева, СтруктураДопДанных, ЮридическиЗначимый = Ложь, ДобавлятьНовыеСтроки = Ложь) Экспорт

...
Процедура ЗаполнитьДанныеДляУКДИнформацияПродавцаФНС(СсылкаНаОбъект, СтруктураЭД, ДеревоДанных, Отказ) Экспорт
	...
	ЗаполнениеОсновнойЧастиУКД(ДанныеДляФормированияЭД, СтруктураЭД, ДеревоДанных);
	ЗаполнениеРасширеннойЧастиУКД(ДанныеДляФормированияЭД, СтруктураЭД, ДеревоДанных);
...
Процедура ЗаполнитьДанныеПередачаТоваровПродавец(СсылкаНаОбъект, СтруктураЭД, ДеревоДанных, Отказ) Экспорт
	...
	Для Каждого ДанныеСтроки Из ТабличнаяЧасть Цикл
		...
		СтрокаТаблицыДокумента.Сопоставление = СтруктураДляСопоставленияНоменклатурыЭД(ДанныеСтроки.Товар);
...
Процедура ЗаполнитьДанныеПередачаРаботИсполнитель(СсылкаНаОбъект, СтруктураЭД, ДеревоДанных, Отказ) Экспорт
	...
	Для Каждого Строка Из ТабличнаяЧасть Цикл
		...
		СтрокаТаблицыДокумента.Сопоставление = СтруктураДляСопоставленияНоменклатурыЭД(Строка.Номенклатура);
...
Процедура ЗаполнитьДанныеПоСчету(СсылкаНаОбъект, СтруктураЭД, ДеревоДокумента, Отказ) Экспорт
	...
	Для Каждого ДанныеСтроки Из ТаблицаДокумента Цикл
		...
		СтрокаТаблицыТоваров.Сопоставление = СтруктураДляСопоставленияНоменклатурыЭД(ДанныеСтроки.Номенклатура);
...
Процедура ЗаполнитьДанныеПоОтчетуОПродажахКомиссионногоТовара(СсылкаНаОбъект, СтруктураЭД, ДеревоДокумента, Отказ) Экспорт
	...
	Для Каждого СтрокаТаблицы Из ТаблицаТоваров Цикл
		СтрокаТаблицы.Сопоставление = СтруктураДляСопоставленияНоменклатурыЭД(СтрокаТаблицы.Номенклатура);
	КонецЦикла;
	ЭлектронноеВзаимодействие.ЗагрузитьТаблицуВДерево(ДеревоДокумента, ТаблицаТоваров, "Товары");
...
Процедура СохранитьДанныеОбъектаВБД(СтрокаДляЗагрузки, ДеревоРазбора, ПараметрыОбработки, НайденныйОбъект = Неопределено) Экспорт
	...
	ИначеЕсли СтрокаДляЗагрузки.ВидЭД = Перечисления.ВидыЭД.СоглашениеОбИзмененииСтоимостиОтправитель 
		ИЛИ	СтрокаДляЗагрузки.ВидЭД = Перечисления.ВидыЭД.УКД Тогда
...
Процедура НайтиСоздатьДокументПередачаТоваров(ДеревоДанных, СсылкаНаВладельца, Записывать = Истина, СпособОбработки = "") Экспорт
	...
	Попытка
		...
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеОбъекта, СпособОбработки, "НайтиСоздатьДокументПередачаТоваров");
...
Процедура НайтиСоздатьДокументПередачаРезультатовРабот(ДеревоДанных, СсылкаНаВладельца, Записывать = Истина, СпособОбработки = "") Экспорт
	...
	Попытка
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеОбъекта, СпособОбработки, "НайтиСоздатьДокументПередачаРезультатовРабот");
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
...
Процедура НайтиСоздатьУниверсальныйПередаточныйДокумент(ДеревоДанных, СсылкиНаВладельцев = Неопределено,
	...
	Попытка
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(ПервичныйДокумент, ДанныеУПД, СпособОбработки, "НайтиСоздатьУниверсальныйПередаточныйДокумент");
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СчетФактура, ДанныеУПД, СпособОбработки, "НайтиСоздатьУниверсальныйПередаточныйДокумент", Истина);
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
...
Процедура НайтиСоздатьУПДДокументОПередаче(ДеревоДанных, СсылкаНаВладельца = Неопределено, Записывать = Истина, СпособОбработки = "") Экспорт
	...
	Попытка
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеУПД, СпособОбработки, "НайтиСоздатьУПДДокументОПередаче");
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
...
Процедура НайтиСоздатьУПДСчетФактуру(ДеревоДанных, СсылкаНаВладельца = Неопределено, Записывать = Истина, СпособОбработки = "") Экспорт
	...
	Попытка
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ДанныеУПДП = ПодготовитьСтруктуруДляПоступленияТоваровУслугУПД(ДеревоДанных);
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеУПДП, СпособОбработки, "НайтиСоздатьУПДДокументОПередаче");
		ДанныеУПД.Вставить("ок_ДанныеПоступление", ДанныеУПДП);
		
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеУПД, СпособОбработки, "НайтиСоздатьУПДСчетФактуру", Истина);
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
...
Процедура НайтиСоздатьУниверсальныйКорректировочныйДокумент(ДеревоДанных, СсылкиНаВладельцев = Неопределено,
	...
	Попытка
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(ПервичныйДокумент, ДанныеУКД, СпособОбработки, "НайтиСоздатьУниверсальныйКорректировочныйДокумент");
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СчетФактура, ДанныеУКД, СпособОбработки, "НайтиСоздатьУниверсальныйКорректировочныйДокумент", Истина);
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)		
...
Процедура НайтиСоздатьУКДДокументОбИзмененииСтоимости(ДеревоДанных, СсылкаНаВладельца = Неопределено, Записывать = Истина, СпособОбработки = "") Экспорт
	...
	Попытка
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеУКД, СпособОбработки, "НайтиСоздатьУКДДокументОбИзмененииСтоимости");
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
...
Процедура НайтиСоздатьУКДСчетФактуру(ДеревоДанных, СсылкаНаВладельца = Неопределено, Записывать = Истина, СпособОбработки = "") Экспорт
	...
	Попытка
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ДанныеУКДП = ПодготовитьСтруктуруДляКорректировкиПоступленияУКД(ДеревоДанных);
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеУКДП, СпособОбработки, "НайтиСоздатьУКДДокументОбИзмененииСтоимости");
		ДанныеУКД.Вставить("ок_ДанныеПоступление", ДанныеУКДП);
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеУКД, СпособОбработки, "НайтиСоздатьУКДСчетФактуру", Истина);
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
...
Функция ПодготовитьСтруктуруДляПоступленияТоваровУслугПоПередачаРаботЭкспортируемая(ДеревоДанных) Экспорт
	
	Возврат ПодготовитьСтруктуруДляПоступленияТоваровУслугПоПередачаРабот(ДеревоДанных);
	
КонецФункции	

Функция ПодготовитьСтруктуруДляПоступленияТоваровУслугУПДЭкспортируемая(ДеревоДанных) Экспорт
	
	Возврат ПодготовитьСтруктуруДляПоступленияТоваровУслугУПД(ДеревоДанных);

КонецФункции	

Функция ПодготовитьСтруктуруДляПоступленияТоваровУслугЭкспортируемая(СтрокаДляЗагрузки, ДеревоРазбора) Экспорт
	
	Возврат ПодготовитьСтруктуруДляПоступленияТоваровУслуг(СтрокаДляЗагрузки, ДеревоРазбора);

КонецФункции	

Процедура ЗаписатьДокументЭкспортируемая(ДокументОбъект, РежимЗаписи) Экспорт
...
Процедура НайтиСоздатьУниверсальныйПередаточныйДокумент_2019(ДеревоДанных, СсылкиНаВладельцев = Неопределено, СпособОбработки = Неопределено) Экспорт
	...
	Попытка
		...
		ДанныеУПД = ПодготовитьСтруктуруДляПоступленияТоваровУслугУПД_2019(ДеревоДанных);
		
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(ПервичныйДокумент, ДанныеУПД, СпособОбработки, "НайтиСоздатьУниверсальныйПередаточныйДокумент_2019");
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
		...
		ДанныеУПД = ПодготовитьСтруктуруДляСчетаФактурыУПД_2019(ДеревоДанных);
		
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СчетФактура, ДанныеУПД, СпособОбработки, "НайтиСоздатьУниверсальныйПередаточныйДокумент_2019", Истина);
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
...
Процедура НайтиСоздатьУПДДокументОПередаче_2019(ДеревоДанных, СсылкаНаВладельца = Неопределено, Записывать = Истина, СпособОбработки = "") Экспорт
	...
	Попытка
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеУПД, СпособОбработки, "НайтиСоздатьУПДДокументОПередаче_2019");
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
...
Процедура НайтиСоздатьУПДСчетФактуру_2019(ДеревоДанных, СсылкаНаВладельца = Неопределено, СпособОбработки = "") Экспорт
	...
	Попытка
		...
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-12-24 (#3594)
		ДанныеУПДП = ПодготовитьСтруктуруДляПоступленияТоваровУслугУПД_2019(ДеревоДанных);
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеУПДП, СпособОбработки, "НайтиСоздатьУПДДокументОПередаче_2019");
		ДанныеУПД.Вставить("ок_ДанныеПоступление", ДанныеУПДП);
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-12-24 (#3594)
		
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
		ок_ОбменСКонтрагентамиВнутренний.ДополнитьДанныеОбъектаДляСозданияУчетногоДокумента(СсылкаНаВладельца, ДанныеУПД, СпособОбработки, "НайтиСоздатьУПДСчетФактуру_2019", Истина);
		//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)		
...
Процедура ЗаполнитьОсновнуюЧастьУКД_2020(ДанныеДляФормированияЭД, Настройки, ДеревоДанных)
	...
	Если Настройки.Функция = "КСЧФДИС"
		ИЛИ Настройки.Функция = "КСЧФ" Тогда
	...
	Если ДанныеШапки.Исправление И Настройки.Функция = "ДИС" Тогда
		ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(ДеревоДанных, "НомерИсправления",
...
Функция ПодготовитьСтруктуруДляКорректировкиПоступленияУКД_2020(ДеревоДанных, ОписаниеОшибки = "")
	...
	КорректировкаПустаяСсылка = Документы.КорректировкаПоступления.ПустаяСсылка();
	Товары                   = КорректировкаПустаяСсылка.Товары.ВыгрузитьКолонки();
	Услуги                   = КорректировкаПустаяСсылка.Услуги.ВыгрузитьКолонки();
	СведенияПрослеживаемости = КорректировкаПустаяСсылка.СведенияПрослеживаемости.ВыгрузитьКолонки();
	...
	Для Каждого СведенияОТоваре Из СведенияОТоварах.Строки Цикл
		...
		Если Не(ЗначениеЗаполнено(Номенклатура)
			...
			ЗаполнитьЗначенияСвойств(НоваяСтрокаУслуги,НоваяСтрока);
			НоваяСтрокаУслуги.Содержание = ЭлектронноеВзаимодействие.ЗначениеРеквизитаВДереве(СведенияОТоваре, "СведенияОТоварах.НомерСтроки.ТоварНаименование");
		КонецЕсли;
...
Процедура ПодготовитьСведенияОПрослеживаемостиДляДокументаИБ_УКД(Приемник, СтрокаТовары, СведенияОТоваре)
	...
	Для Каждого СтрокаДанных Из Данные Цикл
		...
		СтрокаПрослеживаемости.Количество                 = СтрокаДанных.КоличествоТовараПослеИзменения;
	КонецЦикла;
...
//
Процедура ПриПодбореВариантовСопоставленияНоменклатуры(НаборНоменклатурыКонтрагентов, Варианты, СтандартнаяОбработка = Истина) Экспорт
	...
	ДанныеНоменклатурыКонтрагентов.Колонки.Добавить("НаименованиеПолное", ОбщегоНазначения.ОписаниеТипаСтрока(1000));
	ДанныеНоменклатурыКонтрагентов.Колонки.Добавить("Артикул"           , ОбщегоНазначения.ОписаниеТипаСтрока(25));
	ДанныеНоменклатурыКонтрагентов.Колонки.Добавить("ЕдиницаИзмерения"  , Новый ОписаниеТипов("СправочникСсылка.КлассификаторЕдиницИзмерения"));
	ДанныеНоменклатурыКонтрагентов.Колонки.Добавить("ВидСтавкиНДС"      , Новый ОписаниеТипов("ПеречислениеСсылка.ВидыСтавокНДС"));
	
	ШтрихкодыНоменклатурыКонтрагентов = Новый ТаблицаЗначений;
	ШтрихкодыНоменклатурыКонтрагентов.Колонки.Добавить("НомерСтроки",        ОбщегоНазначения.ОписаниеТипаЧисло(10));
	ШтрихкодыНоменклатурыКонтрагентов.Колонки.Добавить("Штрихкод"          , ОбщегоНазначения.ОписаниеТипаСтрока(200));
	...
	Для Каждого НоменклатураКонтрагентов Из НаборНоменклатурыКонтрагентов Цикл
		...
		СтрокаТаблицы.НаименованиеПолное = НоменклатураКонтрагентов.Наименование;
		СтрокаТаблицы.Артикул            = НоменклатураКонтрагентов.Артикул;
		СтрокаТаблицы.ЕдиницаИзмерения   = ЕдиницаИзмеренияПоДаннымКонтрагента(
			НоменклатураКонтрагентов.ЕдиницаИзмеренияКод, НоменклатураКонтрагентов.ЕдиницаИзмерения);
		СтрокаТаблицы.ВидСтавкиНДС       = ВидСтавкиНДСПоДаннымКонтрагента(НоменклатураКонтрагентов.СтавкаНДС);
		Если ЗначениеЗаполнено(НоменклатураКонтрагентов.Штрихкод) Тогда
		
			МассивШтрихкодов = СтрРазделить(НоменклатураКонтрагентов.Штрихкод, ",");
			Для каждого Штрихкод Из МассивШтрихкодов Цикл
				СтрокаШтрихкода = ШтрихкодыНоменклатурыКонтрагентов.Добавить();
				
				СтрокаШтрихкода.НомерСтроки = НомерСтроки;
				СтрокаШтрихкода.Штрихкод    = Штрихкод;
			КонецЦикла;
		КонецЕсли; 
	КонецЦикла;
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ДанныеНоменклатурыКонтрагентов.НаименованиеПолное КАК НаименованиеПолное,
	...
	|	ДанныеНоменклатурыКонтрагентов.ВидСтавкиНДС КАК ВидСтавкиНДС
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ШтрихкодыНоменклатурыКонтрагентов.НомерСтроки КАК НомерСтроки,
	|	ШтрихкодыНоменклатурыКонтрагентов.Штрихкод КАК Штрихкод
	|ПОМЕСТИТЬ ВТ_ШтрихкодыНоменклатурыКонтрагентов
	|ИЗ
	|	&ШтрихкодыНоменклатурыКонтрагентов КАК ШтрихкодыНоменклатурыКонтрагентов
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТ_ШтрихкодыНоменклатурыКонтрагентов.НомерСтроки КАК НомерСтроки,
	|	ШтрихкодыНоменклатуры.Номенклатура КАК Номенклатура,
	|	ШтрихкодыНоменклатуры.Штрихкод КАК Штрихкод
	|ПОМЕСТИТЬ ВТ_СопоставленныеШтрихкоды
	|ИЗ
	|	ВТ_ШтрихкодыНоменклатурыКонтрагентов КАК ВТ_ШтрихкодыНоменклатурыКонтрагентов
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ШтрихкодыНоменклатуры КАК ШтрихкодыНоменклатуры
	|		ПО ВТ_ШтрихкодыНоменклатурыКонтрагентов.Штрихкод = ШтрихкодыНоменклатуры.Штрихкод
	|ГДЕ
	...
	|	ВЫБОР
	|		КОГДА СправочникНоменклатура.Артикул = ВТДанныеНоменклатурыКонтрагентов.Артикул
	|			ТОГДА 1
	|		ИНАЧЕ 0
	|	КОНЕЦ + ВЫБОР
	|		КОГДА СправочникНоменклатура.ЕдиницаИзмерения = ВТДанныеНоменклатурыКонтрагентов.ЕдиницаИзмерения
	|			ТОГДА 1
	|		ИНАЧЕ 0
	|	КОНЕЦ + ВЫБОР
	|		КОГДА СправочникНоменклатура.ВидСтавкиНДС = ВТДанныеНоменклатурыКонтрагентов.ВидСтавкиНДС
	|			ТОГДА 1
	|		ИНАЧЕ 0
	|	КОНЕЦ + ВЫБОР
	|		КОГДА НЕ ШтрихкодыНоменклатуры.Номенклатура ЕСТЬ NULL
	|			ТОГДА 2
	|		ИНАЧЕ 0
	...
	|		ПО ВТДанныеНоменклатурыКонтрагентов.НаименованиеПолное = СправочникНоменклатура.НаименованиеПолное
	|			И (НЕ СправочникНоменклатура.ПометкаУдаления)
	|			И (НЕ СправочникНоменклатура.ЭтоГруппа)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_СопоставленныеШтрихкоды КАК ШтрихкодыНоменклатуры
	|		ПО ВТДанныеНоменклатурыКонтрагентов.НомерСтроки = ШтрихкодыНоменклатуры.НомерСтроки
	|			И (СправочникНоменклатура.Ссылка = ШтрихкодыНоменклатуры.Номенклатура)
	|
	|УПОРЯДОЧИТЬ ПО
	|	НомерСтроки,
	|	ВесВыборки УБЫВ
	...
	Запрос.УстановитьПараметр("ШтрихкодыНоменклатурыКонтрагентов", ШтрихкодыНоменклатурыКонтрагентов);
	...
	Пока ВыборкаНомерСтроки.Следующий() Цикл
		...
		Если ВыборкаВесВыборки.Следующий() Тогда
			...
			Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
				...
				Данные.Вставить("НоменклатураКонтрагента", НаборНоменклатурыКонтрагентов[ВыборкаДетальныеЗаписи.НомерСтроки - 1]);
				Данные.Вставить("НоменклатураИБ",
					ОбменСКонтрагентамиКлиентСервер.НоваяНоменклатураИнформационнойБазы(ВыборкаДетальныеЗаписи.Номенклатура));
				Данные.Вставить("Наименование", ВыборкаДетальныеЗаписи.Наименование);
				Данные.Вставить("Артикул"     , ВыборкаДетальныеЗаписи.Артикул);
				Данные.Вставить("Штрихкод"    , ВыборкаДетальныеЗаписи.Штрихкод);
				Варианты.Добавить(Данные);
			КонецЦикла;
		КонецЕсли;
	КонецЦикла;
...
Процедура ПриЗаполненииФормыНоменклатурыПоДаннымКонтрагента(НоменклатураКонтрагента, Форма) Экспорт
	...
	Форма.Штрихкоды           = НоменклатураКонтрагента.Штрихкод;
...
Процедура ЗаполнитьОсновнуюЧастьУПД(ДанныеДляФормированияЭД, СтруктураЭД, ДеревоДанных)
	...
	Для каждого Строка Из ДанныеДляФормированияЭД.ТаблицаДокумента Цикл
		...
		НоваяСтрока.Сопоставление = СтруктураДляСопоставленияНоменклатурыЭД(Строка.Товар);
...
Процедура ЗаполнениеОсновнойЧастиУКД(ДанныеДляФормированияЭД, СтруктураЭД, ДеревоДанных)
	...
	Если СтруктураЭД.ТипЭлементаВерсииЭД = Перечисления.ТипыЭлементовВерсииЭД.ДИСУКД Тогда
		...
		ДанныеРеализации = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДанныеДляФормированияЭД.Ссылка,
			"ДокументРеализации.Номер, ДокументРеализации.Дата");
		
		ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(ДеревоДанных, "НомерИсходногоДокумента",
			ПрефиксацияОбъектовКлиентСервер.НомерНаПечать(ДанныеРеализации.ДокументРеализацииНомер, Истина, Истина));
		ЭлектронноеВзаимодействие.ЗаполнитьЗначениеРеквизитаВДереве(ДеревоДанных, "ДатаИсходногоДокумента",
			ДанныеРеализации.ДокументРеализацииДата);
	...
	УчетАгентскогоНДСПокупателем = Ложь; // используется для реализации металлолома, сырых шкур животных.
	Если ДокументыОснования.Количество() > 0
		И (ТипЗнч(ДокументыОснования[0]) = Тип("ДокументСсылка.КорректировкаРеализации")
		ИЛИ ТипЗнч(ДокументыОснования[0]) = Тип("ДокументСсылка.СчетФактураВыданный")) Тогда
...
Процедура ЗаполнениеРасширеннойЧастиУКД(ДанныеДляФормированияЭД, СтруктураЭД, ДеревоДанных)
...
Процедура ЗаполнитьДокументКорректировкиПоступления(Документ, ДанныеДокумента)
	...
	ок_ОбменСКонтрагентамиВнутренний.ЗаполнитьДокументПоступления2019(Документ, ДанныеДокумента, СтандартнаяОбработка);
...
Процедура ЗаполнитьДокументСчетФактураПолученный(Документ, ДанныеДокумента)
	...
	//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-08-05 (#3364)
	СтандартнаяОбработка = Истина;
	ок_ОбменСКонтрагентамиВнутренний.ЗаполнитьДокументСчетФактураПолученный2019(Документ, ДанныеДокумента, СтандартнаяОбработка);
	Если Не СтандартнаяОбработка Тогда
		Возврат;
	КонецЕсли;	
	//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Конец 2019-08-05 (#3364)
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-08-03 (#4214)
	Если ДанныеДокумента.Свойство("ок_ДанныеПоступление")
		И ДанныеДокумента.ок_ДанныеПоступление.СведенияПрослеживаемости.Количество() > 0 
		...
		И ДокументОснование.СведенияПрослеживаемости.Количество() = 0 Тогда
		
		ДокументОснованиеОбъект = ДокументОснование.ПолучитьОбъект();
		ДокументОснованиеОбъект.Товары.Загрузить(ДанныеДокумента.ок_ДанныеПоступление.Товары);
		ДокументОснованиеОбъект.СведенияПрослеживаемости.Загрузить(ДанныеДокумента.ок_ДанныеПоступление.СведенияПрослеживаемости);
		Попытка	
			ДокументОснованиеОбъект.Записать();
		Исключение
		    ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Не удалось загрузить сведения о прослеживаемости в документ :" + ДокументОснование + " по причине " + ОписаниеОшибки());
		КонецПопытки;
	КонецЕсли;
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-08-03 (#4214) 
...
Процедура ПолучитьНоменклатуруПоКонтрагентуИИдентификатору(ДанныеДляЗаполненияСтрокиТЧ, СтрокаДереваНоменклатура, ДеревоРазбора)
	...
	Если ЗначениеЗаполнено(Контрагент) Тогда
		СтруктураПоискаНоменклатуры = ОбменСКонтрагентамиКлиентСервер.НоваяНоменклатураКонтрагента(
			Контрагент, ИдентификаторНоменклатуры);
			
		МассивНайденнойНоменклатуры = ОбменСКонтрагентами.НайтиСоответствиеНоменклатуры(
		...
		Если ТипЗнч(НайденныеДанные) = Тип("Структура") Тогда
			ДанныеДляЗаполненияСтрокиТЧ.Вставить("Номенклатура", НайденныеДанные.Номенклатура);
		КонецЕсли;
	КонецЕсли;
...
Функция ОснованиеСФУчаствуетВЭДО(СчетФактура)
	...
	Если Не (ТипЗнч(СчетФактура) = Тип("ДокументСсылка.СчетФактураВыданный") ИЛИ ТипЗнч(СчетФактура) = Тип("ДокументСсылка.СчетФактураВыданный")) Тогда
		Возврат Ложь;
	КонецЕсли;
	...
	ТипЗначенияДокументаОснования = ТипЗнч(ДокументОснование);
	Возврат ТипЗначенияДокументаОснования = Тип("ДокументСсылка.РеализацияТоваровУслуг")
		ИЛИ ТипЗначенияДокументаОснования = Тип("ДокументСсылка.ПоступлениеТоваровУслуг")
		ИЛИ ТипЗначенияДокументаОснования = Тип("ДокументСсылка.ОтчетКомитентуОПродажах")
		ИЛИ ТипЗначенияДокументаОснования = Тип("ДокументСсылка.ОтчетКомиссионераОПродажах")
		ИЛИ ТипЗначенияДокументаОснования = Тип("ДокументСсылка.КорректировкаРеализации")
		ИЛИ ТипЗначенияДокументаОснования = Тип("ДокументСсылка.КорректировкаПоступления");
...
Функция НазначениеПлатежаДляСчетаНаОплату(Знач Наименование, Знач Номер, Знач Дата)
	...
	Если ДоговорУказан(Наименование) Тогда
		НазначениеПлатежа = ДанныеДоговора.Наименование
			+ ?(ЗначениеЗаполнено(ДанныеДоговора.Номер), " " + "№" + " " + ДанныеДоговора.Номер, "")
			+ ?(ЗначениеЗаполнено(ДанныеДоговора.Дата), " " + НСтр("ru = 'от'") + " " + ДанныеДоговора.ДатаСтр, "");
	Иначе
		НазначениеПлатежа = "";
	КонецЕсли;
...
Функция ПодготовитьТаблицуДанныхДоговораУПД(Знач Наименование, Знач Номер, Знач Дата)
	...
	НоваяСтрока = ТаблицаДанныхДоговора.Добавить();
	НоваяСтрока.ДокументНаименование = ДанныеДоговора.Наименование;
	НоваяСтрока.ДокументНомер        = ДанныеДоговора.Номер;
	НоваяСтрока.ДокументДата         = ДанныеДоговора.Дата;
...
#Область СозданиеЗаполнениеДокументаИБ
...
#Область ПодготовкаСтруктурДокументовПередСозданиемЗаполнениемДокументаИБ
...
Функция ПодготовитьСтруктуруДляПоступленияТоваровУслугПоПередачаРабот(ДеревоДанных)
	...
	Для Каждого СведенияОТоваре Из СведенияОТоварах.Строки Цикл
		...
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2019-06-18 (#3377)
		НаименованиеНоменклатуры = ЭлектронноеВзаимодействие.ЗначениеРеквизитаВДереве(СведенияОТоваре,
				"ТаблицаУслуг.НомерСтроки.НаименованиеНоменклатуры");
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Конец 2019-06-18 (#3377)
...
Процедура ЗаполнитьОсновнуюЧастьУПД_2019(ДанныеДляФормированияЭД, СтруктураЭД, ДеревоДанных)
	...
	Для каждого Строка Из ДанныеДляФормированияЭД.ТаблицаДокумента Цикл
		...
		ЭлектронноеВзаимодействиеИСМП.ЗаполнитьСведенияОМаркировке(НоваяСтрока, Строка, ТаблицаКодовМаркировки, ОбъектыСОграничениемДлины);
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-08-12 (#4214)
	...
	Если ТипЗнч(СтруктураЭД.Владелец) = Тип("ДокументСсылка.СчетФактураВыданный") Тогда
		
		Если ТипЗнч(СтруктураЭД.ДокументыОснования) = Тип("Массив")
			И СтруктураЭД.ДокументыОснования.Количество() > 0 Тогда
			
			ДокументОснования = СтруктураЭД.ДокументыОснования[0];
			
			НоваяСтрока = ДокументыПодтвержденияОтгрузки.Добавить();
			НоваяСтрока.Наименование = Строка(ТипЗнч(ДокументОснования));
			НоваяСтрока.Номер = ДокументОснования.Номер;
			НоваяСтрока.Дата = ДокументОснования.Дата;

		КонецЕсли;
	Иначе		
		НоваяСтрока = ДокументыПодтвержденияОтгрузки.Добавить();
		НоваяСтрока.Наименование = Строка(ТипЗнч(СтруктураЭД.Владелец));
		НоваяСтрока.Номер = СтруктураЭД.Владелец.Номер;
		НоваяСтрока.Дата = СтруктураЭД.Владелец.Дата;
	КонецЕсли;
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-08-12 (#4214) 
...
Функция ПодготовитьСтруктуруДляПоступленияТоваровУслугУПД_2019(ДеревоДанных)
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-07-20 (#4214)
	//Товары = Документы.ПоступлениеТоваровУслуг.ПустаяСсылка().Товары.ВыгрузитьКолонки();
	ПоступлениеПустаяСсылка   = Документы.ПоступлениеТоваровУслуг.ПустаяСсылка();
	Товары                    = ПоступлениеПустаяСсылка.Товары.ВыгрузитьКолонки();
	СведенияПрослеживаемости  = ПоступлениеПустаяСсылка.СведенияПрослеживаемости.ВыгрузитьКолонки();
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-07-20 (#4214) 
	...
	Для Каждого СведенияОТоваре Из СведенияОТоварах.Строки Цикл
		...
		ДобавитьШтрихкодыТаблицуШтрихкодовУпаковок(ШтрихкодыУпаковок, СведенияОТоваре);
	КонецЦикла;
...
Функция ПодготовитьСтруктуруДляСчетаФактурыУПД_2019(ДеревоДанных)
	...
	Если ДанныеОбъекта.ВидСчетаФактуры = Перечисления.ВидСчетаФактурыПолученного.НаАванс Тогда
		...
		Для Каждого СведенияОТоваре Из СведенияОТоварах.Строки Цикл
			СтрокаАвансы = ТаблицаАвансы.Добавить();
			СтрокаАвансы.СтавкаНДС = ЭлектронноеВзаимодействие.ЗначениеРеквизитаВДереве(
				СведенияОТоваре,
				"СведенияОТоварах.НомерСтроки.НалоговаяСтавка");
			СтрокаАвансы.Сумма = ЭлектронноеВзаимодействие.ЗначениеРеквизитаВДереве(
				СведенияОТоваре,
...
Функция ШтрихкодыНоменклатуры(Номенклатура)
	...
	Иначе
		...
		МассивШтрихкодов = ОбщегоНазначения.ВыгрузитьКолонку(РезультатЗапроса.Выгрузить(), "Штрихкод");
		
		Возврат СтрСоединить(МассивШтрихкодов, ",");
	КонецЕсли; 
КонецФункции 

Функция СтруктураДляСопоставленияНоменклатурыЭД(Номенклатура)
	...
	ЗначенияРеквизитовНоменклатуры = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Номенклатура,
		"НаименованиеПолное, Артикул, ВидСтавкиНДС, ЕдиницаИзмерения, ЕдиницаИзмерения.Наименование, ЕдиницаИзмерения.Код");
	
	Результат.Вставить("Наименование", ЗначенияРеквизитовНоменклатуры.НаименованиеПолное);
	...
	Если ЗначениеЗаполнено(ЗначенияРеквизитовНоменклатуры.ВидСтавкиНДС) Тогда
		СтавкаНДС = Перечисления.СтавкиНДС.СтавкаНДС(ЗначенияРеквизитовНоменклатуры.ВидСтавкиНДС, ТекущаяДатаСеанса());
	...
	Результат.Вставить("Штрихкод", ШтрихкодыНоменклатуры(Номенклатура));
...
Процедура НайтиОрганизациюПоДаннымЭД(ДанныеОбъекта, ДеревоДанных, ВидУчастника)
	...
	Если ТипУчастника = "ЮЛ" Тогда
		...
		Запрос.Текст = 
			"ВЫБРАТЬ ПЕРВЫЕ 1
			//ОКЕЙ Бублик А.А.(СофтЛаб) Начало 2020-08-24 (#3816) Перенесем функционал по определению организации из старого релиза. #3103
			|	ВЫБОР
			|		КОГДА Организации.КПП = &КПП
			|			ТОГДА 0
			|		ИНАЧЕ 1
			|	КОНЕЦ КАК Порядок,
			//ОКЕЙ Бублик А.А.(СофтЛаб) Конец 2020-08-24 (#3816)
			|	Организации.Ссылка КАК Ссылка
			|ИЗ
			|	Справочник.Организации КАК Организации
			|ГДЕ
			|	Организации.ИНН = &ИНН
			//ОКЕЙ Бублик А.А.(СофтЛаб) Начало 2020-08-24 (#3816)
...
Процедура ЗаполнитьСведенияОПрослеживаемостиВДокументеИБ_УКД(Приемник, Источник, Товары) Экспорт
	
	Результат = Приемник.ВыгрузитьКолонки();
	Для Каждого СтрокаТовары Из Товары Цикл
		Если Не СтрокаТовары.ПрослеживаемыйТовар Тогда
			//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-09-14 (#4281) 
			//Возврат;
			Прервать;

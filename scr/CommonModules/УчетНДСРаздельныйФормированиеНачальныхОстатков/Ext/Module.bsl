...
Процедура ЗаполнитьПоТоварнымСчетам(СтруктураПараметров, ТаблицаИспользованныхПартий) 
	...
	ТаблицаСЗаполненнымиПартиями.Колонки.Добавить("ИскатьСуммуНДС");
	ТаблицаСЗаполненнымиПартиями.Колонки.Добавить("НуженДопПоиск");	
	ТаблицаСЗаполненнымиПартиями.Колонки.Добавить("СчетПоступления");
	ТаблицаСЗаполненнымиПартиями.Колонки.Добавить("ИскатьДопРасходы");
	ТаблицаСЗаполненнымиПартиями.Колонки.Добавить("ЭтоКомплектация");
	ТаблицаСЗаполненнымиПартиями.Колонки.Добавить("ИД");
...
Функция ЗаполнитьПоСчетам0708(СтруктураПараметров)
	...
	ТаблицаОстатковПоПартиям.Колонки.Добавить("НуженДопПоиск");
	ТаблицаОстатковПоПартиям.Колонки.Добавить("ИскатьСуммуНДС");
	ТаблицаОстатковПоПартиям.Колонки.Добавить("ИскатьДопРасходы"); 
	ТаблицаОстатковПоПартиям.Колонки.Добавить("ИД");

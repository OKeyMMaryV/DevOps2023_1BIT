...
Функция ВыгрузкаВАрхивеСовместимаСТекущейВерсиейКонфигурации(Знач ИнформацияОВыгрузке) Экспорт
	...
	Возврат ИнформацияОВыгрузке.Configuration.Version = бит_ОбщегоНазначения.МетаданныеВерсия();
...
Процедура СохранитьОписаниеВыгрузки(Знач Контейнер)
	...
	ИнформацияОКонфигурации.Version = бит_ОбщегоНазначения.МетаданныеВерсия();

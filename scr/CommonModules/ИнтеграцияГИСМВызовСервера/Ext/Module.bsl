...
Процедура АрхивироватьРаспоряженияКОформлению(Основания, Документ) Экспорт
	
	ТипДокументов = ТипЗнч(Документ);
	Если ТипДокументов = Тип("ДокументСсылка.ЗаявкаНаВыпускКиЗГИСМ") Тогда
		РегистрыСведений.СтатусыЗаявокНаВыпускКиЗГИСМ.АрхивироватьРаспоряженияКОформлению(Основания);
	ИначеЕсли ТипДокументов = Тип("ДокументСсылка.УведомлениеОбОтгрузкеМаркированныхТоваровГИСМ") Тогда
		РегистрыСведений.СтатусыУведомленийОбОтгрузкеМаркированныхТоваровГИСМ.АрхивироватьРаспоряженияКОформлению(Основания);
	Иначе
		РегистрыСведений.СтатусыИнформированияГИСМ.АрхивироватьРаспоряженияКОформлению(Основания);
	КонецЕсли;

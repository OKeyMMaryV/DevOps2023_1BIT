...
Функция ОписаниеВидаТарифа(ТарифСтраховыхВзносов) Экспорт
	...
	ИначеЕсли ТарифСтраховыхВзносов = ОбщегоНазначенияКлиентСервер.ПредопределенныйЭлемент("Справочник.ВидыТарифовСтраховыхВзносов.УчастникСпециальныхАдминистративныхРайонов") Тогда
		ОписаниеТарифа = "Тариф установлен на 2020-2027 годы для страхователей, удовлетворяющих условиям подпункта 16 пункта 1 статьи 427 НК РФ"

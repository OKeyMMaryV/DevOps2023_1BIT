...
Процедура ВывестиДополнительныеПоляПредставленийВОтчет(Объект, ДополнительныеПоляПредставлений) Экспорт
...
Процедура ВывестиВОтчетДополнительныеПоляПредставлений(ОбъектОтчета, ДополнительныеПоляПредставлений) Экспорт
	
	ВывестиВНаборыДанныхДополнительныеПоляПредставлений(ОбъектОтчета.СхемаКомпоновкиДанных.НаборыДанных, ДополнительныеПоляПредставлений);

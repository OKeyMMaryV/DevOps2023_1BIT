...
////1С-ИжТиСи, Кондратьев, 14.03.2020, Обновление (
//Процедура НачатьЗамерПередЗаписью(Источник, Отказ, РежимЗаписи, РежимПроведения) Экспорт
//// 1c-izhtc spawn 31.07.15
//// отклонена подписка
//////++ СВВ {[+](фрагмент добавлен), Администратор 22.07.2015 12:38:55
////	Если (РежимЗаписи = РежимЗаписиДокумента.Проведение) Тогда
////		Описание = ""+Источник.Ссылка;
////		Операция = ОценкаПроизводительностиСерверВызовСервера.ПолучитьОперацию(Источник.Ссылка);
////		НачатьЗамерВремени(Операция);
////	КонецЕсли;
//////-- СВВ}Администратор 22.07.2015 12:38:55
//КонецПроцедуры
...
////	//
////	//
////	//ЗакончитьЗамерВремени(Операция, ВремяНачала);
//////-- СВВ}Администратор 22.07.2015 12:38:55
//КонецПроцедуры
////1С-ИжТиСи, Кондратьев, 14.03.2020, Обновление )

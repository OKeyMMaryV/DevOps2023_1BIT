...
// Получает выписку банка в виде таблицы значений. Повторяет структуру макета Обработки.ОбменСБанками.Макеты.ВыпискаБанка.
//
// Параметры:
//  ЭлектронныеДокументы - ДокументСсылка.СообщениеОбменСБанками, Массив - содержит выписку банка.
//
// Возвращаемое значение:
//  ТаблицаЗначений - содержит данные выписки. Структура соответствует макету Обработки.ОбменСБанками.Макеты.ВыпискаБанка.
//

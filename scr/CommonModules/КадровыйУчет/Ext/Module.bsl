...
Функция НормативныйДокументОснованияУвольнения(ОснованиеУвольнения) Экспорт
	...
	Возврат КадровыйУчетВнутренний.НормативныйДокументОснованияУвольнения(ОснованиеУвольнения);
...
Процедура СоздатьВТПоследниеРаботавшиеСотрудникиФизическихЛиц(МенеджерВременныхТаблиц, ТолькоРазрешенные, ФизическиеЛица, ПараметрыПолученияСотрудников, ИмяВТПоследниеСотрудники = "ВТПоследниеСотрудники") Экспорт
	...
	КадровыйУчетВнутренний.СоздатьВТПоследниеРаботавшиеСотрудникиФизическихЛиц(МенеджерВременныхТаблиц, ТолькоРазрешенные, ФизическиеЛица, ПараметрыПолученияСотрудников, ИмяВТПоследниеСотрудники);
...
Функция ЗапросВТСобытияТрудовыхКнижек(Организация, ТолькоРазрешенные) Экспорт
	...
	Возврат КадровыйУчетВнутренний.ЗапросВТСобытияТрудовыхКнижек(Организация, ТолькоРазрешенные);

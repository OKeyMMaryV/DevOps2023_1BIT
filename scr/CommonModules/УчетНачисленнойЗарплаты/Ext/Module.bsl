...
// 		ЗаписыватьДвижения - Булево.
//
Процедура ЗарегистрироватьПерерасчетНДФЛ(ДанныеДляПроведения, Отказ, НДФЛ, КорректировкиВыплаты, ЗаписыватьДвижения = Ложь) Экспорт

	УчетНачисленнойЗарплатыВнутренний.ЗарегистрироватьПерерасчетНДФЛ(ДанныеДляПроведения, Отказ, НДФЛ, КорректировкиВыплаты, ЗаписыватьДвижения);

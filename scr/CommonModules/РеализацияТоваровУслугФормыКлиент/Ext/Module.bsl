...
Процедура ПослеЗаписи(Форма, ПараметрыЗаписи) Экспорт
	...
	Если ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение 
		...
		ОповеститьОбИзменении(Объект.СчетНаОплатуПокупателю);
	КонецЕсли;
...
Процедура ДоставкаНажатие(Форма, Элемент) Экспорт
...
//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-09-20 (#4214)
...
КонецПроцедуры
//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-09-20 (#4214) 
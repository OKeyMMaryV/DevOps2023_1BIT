...
Процедура УстановитьРежимКомандногоИнтерфейса(Режим) Экспорт
	...
	УстановитьФункциональныеОпцииИспользуемыеИнтерфейсыВМоделиСервиса();
...
//1С-ИжТиСи, Кондратьев, 14.03.2020, Обновление, используется в отчетах СБ (
...
Процедура УстановитьВидимостьКолонокДополнительнойИнформации(Форма) Экспорт
	...
	ИначеЕсли ЕстьКолонкаСписка("Оригинал", Форма) Тогда // используется только основной статус ОригиналПолучен
		...
		Элементы.УстановитьСтатусОригиналПолучен.Видимость   = ЕстьПравоИзмененияСтатусовДокументов И ОтображатьДополнительныеКолонки;
		Элементы.УстановитьСтатусОригиналНеПолучен.Видимость = ЕстьПравоИзмененияСтатусовДокументов И ОтображатьДополнительныеКолонки;
		Элементы.СписокКонтекстноеМенюУстановитьСтатусОригиналПолучен.Видимость   = ЕстьПравоИзмененияСтатусовДокументов;
		Элементы.СписокКонтекстноеМенюУстановитьСтатусОригиналНеПолучен.Видимость = ЕстьПравоИзмененияСтатусовДокументов;
	...
	Если ЕстьКолонкаСписка("СчетФактура", Форма) Тогда
		...
		ОтображатьСчетФактуруВСписках = ПолучитьФункциональнуюОпцию("ИспользуетсяОСНО")
...
Процедура УстановитьФункциональныеОпцииИспользуемыеИнтерфейсыВМоделиСервиса() Экспорт
	...
	ИспользуетсяПростойИнтерфейсВМоделиСервиса = (
		ОбщегоНазначения.РазделениеВключено()
		И ЭтоПростойИнтерфейс());
	
	Константы.ИспользуетсяПростойИнтерфейсВМоделиСервиса.Установить(ИспользуетсяПростойИнтерфейсВМоделиСервиса);

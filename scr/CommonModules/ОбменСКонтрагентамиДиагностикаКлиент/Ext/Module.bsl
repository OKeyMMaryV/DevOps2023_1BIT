...
Процедура ПриОпределенииПараметровВидаОшибки(ВидОшибки, ПараметрыВидаОшибки) Экспорт
	...
	ИначеЕсли ВидОшибки = ОбменСКонтрагентамиДиагностикаКлиентСервер.ВидОшибкиНеПринятоПриглашение() Тогда
	...
	ИначеЕсли ВидОшибки = ОбменСКонтрагентамиДиагностикаКлиентСервер.ВидОшибкиОжидаетсяСогласиеНаПриглашение() Тогда
	...
	ИначеЕсли ВидОшибки = ОбменСКонтрагентамиДиагностикаКлиентСервер.ВидОшибкиТребуетсяОтправкаПриглашения() Тогда
	...
	ИначеЕсли ВидОшибки = ОбменСКонтрагентамиДиагностикаКлиентСервер.ВидОшибкиОшибкаПриглашения() Тогда
...
Процедура ЗапроситьПаролиСертификатов(Контекст) 
	...
	Иначе 
		...
		Сертификаты = РезультатДиагностикиКриптографии.Результаты.НаличиеСертификатов.Сертификаты;
...
Процедура ПроверкиСертификатов(Контекст)
	...
	Сертификаты = Контекст.ПараметрыВыполнения.РезультатДиагностики.Результаты.Криптография.Результаты.НаличиеСертификатов.Сертификаты;
	Обработчики = Новый Массив;
...
Процедура ПроверкиСертификатовПослеЦикла(Результат, Контекст) Экспорт
	...
	КонецЕсли;
	КоличествоДанных = Контекст.ПараметрыВыполнения.РезультатДиагностики.Результаты.Криптография.Результаты.НаличиеСертификатов.Сертификаты.Количество();

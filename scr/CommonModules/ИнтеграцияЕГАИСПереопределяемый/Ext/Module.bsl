...
Процедура РассчитатьСтатусОформленияАктПостановкиНаБалансЕГАИС(Источник, Отказ) Экспорт
	...
	Если НЕ ОбщегоНазначения.ЗначениеСсылочногоТипа(Источник)
		И Источник.ДополнительныеСвойства.Свойство("ГрупповоеПерепроведение") Тогда
		Возврат;
	КонецЕсли;
	
	ИнтеграцияЕГАИСБП.РассчитатьСтатусОформленияДокументаЕГАИС(Источник, Отказ);
...
Процедура ЗапросСтатусаОформленияАктПостановкиНаБалансЕГАИС(Запрос, ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияЕГАИСБП.ЗапросСтатусаОформленияЕГАИС(ДокументОснование, Метаданные.Документы.АктПостановкиНаБалансЕГАИС);
...
Процедура ЗапросСтатусаОформленияАктСписанияЕГАИС(Запрос, ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияЕГАИСБП.ЗапросСтатусаОформленияЕГАИС(ДокументОснование, Метаданные.Документы.АктСписанияЕГАИС);
...
Процедура ЗапросСтатусаОформленияВозвратИзРегистра2ЕГАИС(Запрос, ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияЕГАИСБП.ЗапросСтатусаОформленияЕГАИС(ДокументОснование, Метаданные.Документы.ВозвратИзРегистра2ЕГАИС);
...
Процедура ЗапросСтатусаОформленияПередачаВРегистр2ЕГАИС(Запрос, ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияЕГАИСБП.ЗапросСтатусаОформленияЕГАИС(ДокументОснование, Метаданные.Документы.ПередачаВРегистр2ЕГАИС);
...
Процедура ЗапросСтатусаОформленияТТНИсходящаяЕГАИС(Запрос, ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияЕГАИСБП.ЗапросСтатусаОформленияЕГАИС(ДокументОснование, Метаданные.Документы.ТТНИсходящаяЕГАИС);
...
Процедура ЗапросСтатусаОформленияТТНВходящаяЕГАИС(Запрос, ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияЕГАИСБП.ЗапросСтатусаОформленияЕГАИС(ДокументОснование, Метаданные.Документы.ТТНВходящаяЕГАИС);
...
Процедура ЗапросСтатусаОформленияЧекЕГАИС(Запрос, ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияЕГАИСБП.ЗапросСтатусаОформленияЕГАИС(ДокументОснование, Метаданные.Документы.ЧекЕГАИС);
...
Процедура ЗапросСтатусаОформленияЧекЕГАИСВозврат(Запрос, ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияЕГАИСБП.ЗапросСтатусаОформленияЕГАИС(ДокументОснование, Метаданные.Документы.ЧекЕГАИСВозврат);

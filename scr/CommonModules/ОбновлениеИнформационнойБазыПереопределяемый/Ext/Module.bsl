...
Процедура ПриОпределенииНастроек(Параметры) Экспорт
	...
	// *Обновление*, Братухин М.В., 2018.09.30 (
	// Ускорение установки обновления
...
//    ОбновлениеИнформационнойБазы.ЗарегистрироватьНовуюПодсистему(Метаданные.Имя, бит_ОбщегоНазначения.МетаданныеВерсия());
//  КонецЕсли;
//
...
//   ТекущаяВерсияИБ        - Строка - версия после обновления. Как правило, соответствует бит_ОбщегоНазначения.МетаданныеВерсия()().

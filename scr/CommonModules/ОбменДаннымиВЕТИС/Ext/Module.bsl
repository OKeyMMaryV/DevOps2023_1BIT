...
Процедура ЗаполнитьТаблицуЭлементовПоДате(Список, ПараметрыОбмена, ПараметрыЗапроса, ДокументДляВосстановления = Неопределено) Экспорт
	...
	ТаблицаЭлементовШаблон.Колонки.Добавить("Идентификатор",                 ОписаниеТипаУникальныйИдентификатор);
	ТаблицаЭлементовШаблон.Колонки.Добавить("ИдентификаторВерсии",           ОписаниеТипаУникальныйИдентификатор);
	ТаблицаЭлементовШаблон.Колонки.Добавить("ИдентификаторВСД",              ОписаниеТипаУникальныйИдентификатор);
	ТаблицаЭлементовШаблон.Колонки.Добавить("ИдентификаторЕдиницыИзмерения", ОписаниеТипаУникальныйИдентификатор);
	...
	ТаблицаИдентификаторов.Колонки.Добавить("ИдентификаторЕдиницыИзмерения", ОписаниеТипаУникальныйИдентификатор);
...
Функция ПолучитьДанныеДляФормированияДокументов(ОбщиеДанные)
	...
	Таблица = ОбщиеДанные.ТаблицаЭлементов.Скопировать(,ПереченьКолонок);
	...
	|	ЕСТЬNULL(втВСД.Ссылка, ЗНАЧЕНИЕ(Справочник.ВетеринарноСопроводительныйДокументВЕТИС.ПустаяСсылка)) КАК ВетеринарноСопроводительныйДокументВЕТИС
	|ПОМЕСТИТЬ втТовары
	|ИЗ

...
//
Процедура ЗарегистрироватьПерерасчетНДФЛ(ДанныеДляПроведения, Отказ, НДФЛПоСотрудникам, КорректировкиВыплатыПоСотрудникам, ЗаписыватьДвижения = Ложь) Экспорт
...
//
// Параметры:
//	Движения - КоллекцияДвижений - движения регистратора, которые формируются в СформироватьДвижения.
//	МассивФизическихЛиц - Массив - физические лица, по которым получаются данные.
//	ПериодРегистрации - Дата - определяет период получения данных.
//	Организация - СправочникСсылка.Организации - Организация.
//	ОкончательныйРасчет - Булево.
//	Авансом - Булево - признак того, что требуется получить данные для первой половины месяца.
//

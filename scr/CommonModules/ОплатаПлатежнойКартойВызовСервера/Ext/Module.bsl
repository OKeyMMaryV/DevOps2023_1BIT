...
Функция УправлениеЗачетомАвансовПогашениемЗадолженности() Экспорт
	
	Возврат ПолучитьФункциональнуюОпцию("УправлениеЗачетомАвансовПогашениемЗадолженности");
...
Функция СсылкаНаВыбранныйДокумент(ПараметрыВыполнения)
	...
	Иначе
		...
		Возврат РегистрыСведений.ЧекиНПД.НайтиДокументПоНомеруЧека(
			ПараметрыВыполнения.НомерЧекаНПД, ПараметрыВыполнения.Организация);

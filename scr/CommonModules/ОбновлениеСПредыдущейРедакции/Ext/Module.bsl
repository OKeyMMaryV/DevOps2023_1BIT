...
// 1c-izhtc spawn 29.07.15 (
//Процедура ПереносДопСведенийИзСправочникаВРегистр()
//	
//	Запрос = Новый Запрос;
//	Запрос.Текст =
//	"ВЫБРАТЬ
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.Владелец КАК Владелец,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.Наименование,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.КодЕдиный,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.КодАксапты,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.ФорматОбъекта,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.ДатаОткрытия,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.ДатаЗакрытия,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.Город,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.ПлощадьТорговогоЗала,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.ВидПрава,
//	//|	бит_БК_ДополнительныеСведенияПоОбъекту.Дивизион,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.Регион,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.СтатусОбъекта,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.Адрес,
//	|	бит_БК_ДополнительныеСведенияПоОбъекту.Директор
//	|ИЗ
//	|	Справочник.УдалитьИжтиси_бит_БК_ДополнительныеСведенияПоОбъекту КАК бит_БК_ДополнительныеСведенияПоОбъекту
//	|ГДЕ
//	|	НЕ бит_БК_ДополнительныеСведенияПоОбъекту.ПометкаУдаления
//	|
//	|УПОРЯДОЧИТЬ ПО
//	|	Владелец";
//	
...
//	Попытка
//		
//		Соответствие.Вставить("Наименование",			ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Наименование для отчета",	Тип("Строка")));
//		Соответствие.Вставить("КодЕдиный",				ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Код единый",				Тип("Число")));
//		Соответствие.Вставить("КодАксапты",				ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Код аксапты",				Тип("Строка")));
//		Соответствие.Вставить("ФорматОбъекта",			ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Формат объекта",			Тип("ПеречислениеСсылка.бит_БК_ФорматОбъекта")));
//		Соответствие.Вставить("ДатаОткрытия",			ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Дата открытия",			Тип("Дата")));
//		Соответствие.Вставить("ДатаЗакрытия",			ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Дата закрытия",			Тип("Дата")));
//		Соответствие.Вставить("Город",					ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Город",					Тип("СправочникСсылка.бит_БК_Города")));
//		Соответствие.Вставить("ПлощадьТорговогоЗала",	ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Площадь торгового зала",	Тип("Число")));
//		Соответствие.Вставить("ВидПрава",				ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Вид права",				Тип("ПеречислениеСсылка.бит_БК_ВидПрава")));
//		//Соответствие.Вставить("Дивизион",				ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Дивизион",					Тип("СправочникСсылка.бит_БК_Дивизионы")));
//		Соответствие.Вставить("Регион",					ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Регион",					Тип("СправочникСсылка.бит_БК_Регион")));
//		Соответствие.Вставить("СтатусОбъекта",			ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Статус объекта",			Тип("СправочникСсылка.ОК_СтатусОбъекта")));
//		Соответствие.Вставить("Адрес",					ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Адрес",					Тип("Строка")));
//		Соответствие.Вставить("Директор",				ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент("Директор",					Тип("СправочникСсылка.бит_БК_Инициаторы")));
//		
...
//				МенеджерЗаписи.Объект = Выборка.Владелец;
//				МенеджерЗаписи.Свойство = КлючИЗначение.Значение;
...
//				МенеджерЗаписи.Объект = Выборка.Владелец;
//				МенеджерЗаписи.Свойство = КлючИЗначение.Значение;
//				МенеджерЗаписи.Значение = Выборка[КлючИЗначение.Ключ];
...
//Функция ДополнительныеРеквизитыИСведенияНайтиСоздатьЭлемент(Наименование, Тип)
//	ОбъектПВХСсылка = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.НайтиПоНаименованию(Наименование + " (Объект строительства)", Истина);
//	Если ЗначениеЗаполнено(ОбъектПВХСсылка) Тогда 
//		ОбъектПВХ = ОбъектПВХСсылка.ПолучитьОбъект();
//	Иначе
//		ОбъектПВХ = ПланыВидовХарактеристик.ДополнительныеРеквизитыИСведения.СоздатьЭлемент();
//	КонецЕсли;
//	ОбъектПВХ.Наименование = Наименование + " (Объект строительства)";
//	ОбъектПВХ.Заголовок    = Наименование;
...
//	ОбъектПВХ.НаборСвойств = Справочники.НаборыДополнительныхРеквизитовИСведений.Справочник_ОбъектыСтроительства;
//	ОбновлениеИнформационнойБазы.ЗаписатьОбъект(ОбъектПВХ);
//	ОбъектНаборСвойств = ОбъектПВХ.НаборСвойств.ПолучитьОбъект();
//	ТабличнаяЧасть = ОбъектНаборСвойств.ДополнительныеСведения;
//	НайденнаяСтрока = ТабличнаяЧасть.Найти(ОбъектПВХ.Ссылка, "Свойство");
//	Если НайденнаяСтрока = Неопределено Тогда
//		НоваяСтрока = ТабличнаяЧасть.Добавить();
//		НоваяСтрока.Свойство = ОбъектПВХ.Ссылка;
...
Процедура ПереносРеквизитабитEmailВКИ()
	Запрос= Новый Запрос;
	Запрос.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	КонтактныеЛица.Ссылка
	|ИЗ
	|	Справочник.КонтактныеЛица КАК КонтактныеЛица
	|ГДЕ КонтактныеЛица.битEmail<>""""
	|";
	Выборка = Запрос.Выполнить().Выбрать();
	Пока выборка.Следующий() Цикл
		Попытка
			ОбъектССылка = Выборка.Ссылка.ПолучитьОбъект();
			Для каждого СтрокаКИ Из ОбъектССылка.КонтактнаяИнформация Цикл
				Если СтрокаКИ.Тип = Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты и НЕ ЗначениеЗаполнено(СтрокаКИ.АдресЭП) Тогда 
					СтрокаКИ.АдресЭП = ОбъектССылка.битEmail;
					Прервать;
				КонецЕсли;
			КонецЦикла;
			Если ОбъектССылка.КонтактнаяИнформация.Найти(Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты, "Тип") = Неопределено И ЗначениеЗаполнено(ОбъектССылка.битEmail) Тогда 
				НоваяСтрока = ОбъектССылка.КонтактнаяИнформация.Добавить();
				НоваяСтрока.Тип = Перечисления.ТипыКонтактнойИнформации.АдресЭлектроннойПочты;
				НоваяСтрока.Вид = Справочники.ВидыКонтактнойИнформации.EmailКонтактныеЛица;
				НоваяСтрока.Представление = ОбъектССылка.битEmail;
				НоваяСтрока.АдресЭП = ОбъектССылка.битEmail				
			КонецЕсли;
...
Процедура ПереносКИиДопСвойствПриОбновленииС20() Экспорт
	...
	//ПереносДопСведенийИзСправочникаВРегистр(); // 1c-izhtc spawn 29.07.15
	ПереносРеквизитабитEmailВКИ(); //izhtc alena 02.10.2015(
...
Процедура ПереносКИПриОбновленииС20()
	...
	Пока ВыборкаОбъект.Следующий() Цикл
		...
		УправлениеКонтактнойИнформацией.УстановитьКонтактнуюИнформациюОбъекта(ОбъектВладелец, КонтактнаяИнформацияОбъекта);
...
Процедура ПереносДопСвойствПриОбновленииС20()
	...
	//ижтиси, шадрин, 30.07.2015(
	СоответствиеТипов.Вставить(Тип("СправочникСсылка.ОтветственныеЗаДоговоры")       , "СправочникСсылка.ОтветственныеЗаДоговоры");
	СоответствиеТипов.Вставить(Тип("СправочникСсылка.ПредметДоговора")               , "СправочникСсылка.ПредметДоговора");
	СоответствиеТипов.Вставить(Тип("СправочникСсылка.СтатьиЗатрат")                  , "СправочникСсылка.СтатьиЗатрат");
	СоответствиеТипов.Вставить(Тип("СправочникСсылка.СтатьиДвиженияДенежныхСредств") , "СправочникСсылка.СтатьиДвиженияДенежныхСредств");
	//ижтиси, шадрин, 30.07.2015)

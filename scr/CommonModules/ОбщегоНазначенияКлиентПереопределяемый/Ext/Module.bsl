...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	бит_ОбщегоНазначенияКлиентПереопределяемый.ПередНачаломРаботыСистемы(Параметры.Отказ); //раньше был параметр Отказ
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	ПараметрыРаботыКлиента = СтандартныеПодсистемыКлиент.ПараметрыРаботыКлиентаПриЗапуске();
	// бит_Финанс Изменение кода. Начало.
	бит_ОбщегоНазначенияКлиентПереопределяемый.ПриНачалеРаботыСистемы(Параметры);
	// бит_Финанс Изменение кода. Конец.
	...
	//ОКЕЙ Бублик А.А.(СофтЛаб) Начало 2020-09-15 (#3816) - в новом релизе затерли код
	//ОК(СофтЛаб) Вдовиченко Г.В. 20181101 №3103
	ок_обменСКонтрагентамиКлиент.ПриНачалеРаботыСистемы(Параметры);
	//ОК(СофтЛаб) Вдовиченко Г.В. 20181101 №3103
	//ОКЕЙ Бублик А.А.(СофтЛаб) Конец 2020-09-15 (#3816)

...
СписокОбъектов.Добавить(Справочники.БанковскиеСчета);                                
	...
	СписокОбъектов.Добавить(Документы.ИзменениеОтраженияРасходовПоАренднымПлатежамОС);
	СписокОбъектов.Добавить(Документы.ИзменениеУсловийАренды);
	...
	СписокОбъектов.Добавить(Документы.ПоступлениеВАренду);
	...
	// бит_Финанс изменения кода. Начало: 09.08.2018
	бит_УправлениеПечатьюПереопределяемый.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
	// бит_Финанс изменения кода. Конец 09.08.2018 

...
Процедура ЗаполнениеРеквизитовФормы(Форма) Экспорт
	...
	ПараметрыИнтеграции = Форма.ПараметрыИнтеграцииГосИС.Получить(Перечисления.ВидыПродукцииИС.Обувная);
	Если ПараметрыИнтеграции = Неопределено Тогда
		ПараметрыИнтеграции = Форма.ПараметрыИнтеграцииГосИС.Получить(Перечисления.ВидыПродукцииИС.Табачная);
	КонецЕсли;
	Если ПараметрыИнтеграции = Неопределено Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПриИзмененииЭлемента(Форма, Элемент, ДополнительныеПараметры) Экспорт
	...
	Если Форма.ИмяФормы = "Документ.РеализацияТоваровУслуг.Форма.ФормаДокументаОбщая"
		...
		Если Элемент = "Номенклатура" 
			...
			СвойстваПродукции = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДополнительныеПараметры.Номенклатура, "ТабачнаяПродукция, ОбувнаяПродукция");
			Если СвойстваПродукции.ТабачнаяПродукция
				ИЛИ СвойстваПродукции.ОбувнаяПродукция Тогда
				ВидыПродукцииИС = ?(СвойстваПродукции.ТабачнаяПродукция, Перечисления.ВидыПродукцииИС.Табачная, Перечисления.ВидыПродукцииИС.Обувная);

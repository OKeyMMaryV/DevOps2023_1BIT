...
#Область ПодготовкаОбщихДанных
	...
	//ОКЕЙ Сафронов А.А. (СофтЛаб) Начало 2020-12-23 (#3946)
	//Запрос.УстановитьПараметр("ЭтоДекларация1кв2019",    ПараметрыОтчета.ПравилаЗаполнения = "2019Кв1");
	...
	ИначеЕсли ПараметрыОтчета.ПравилаЗаполнения = "2017Кв1" Тогда
		МакетыРасшифровкиПолей = МакетыРасшифровкиПолей2017Кв1(
			ПараметрыОтчета.Организация, ПараметрыОтчета.мДатаКонцаПериодаОтчета);
	//ОКЕЙ Сафронов А.А. (СофтЛаб) Начало 2020-12-23 (#3946)
	//ИначеЕсли ПараметрыОтчета.ПравилаЗаполнения = "2019Кв1" Тогда
...
#Область Раздел3
	...
	Если Контейнер.Свойство("Раздел3")
		...
		Если Раздел3Начисления.Следующий() Тогда
			...
			// ОКЕЙ Смирнов М.В. (СофтЛаб) Начало 2021-09-09 (#4347)
			//Если ПараметрыОтчета.ПравилаЗаполнения = "2019Кв1"
			// //ОКЕЙ Сафронов А.А. (СофтЛаб) Начало 2020-12-23 (#3946)
			// ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2020Кв4"
			// //ОКЕЙ Сафронов А.А. (СофтЛаб) Конец 2020-12-23 (#3946)
			// ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2017Кв1" Тогда
			Если ПараметрыОтчета.ПравилаЗаполнения = "2021Кв3"
				ИЛИ ПараметрыОтчета.ПравилаЗаполнения = "2020Кв4"
		...
		// ОКЕЙ Смирнов М.В. (СофтЛаб) Начало 2021-09-09 (#4347)
			//ОКЕЙ Сафронов А.А. (СофтЛаб) Начало 2020-12-23 (#3946)
			////Если ПараметрыОтчета.ПравилаЗаполнения = "2019Кв1" Тогда
